...
| Field | Value |
|---|---|
| Artifact hashes generated | **PENDING** — will be generated by the `Phase 2F Finalize Baseline` GitHub Actions workflow once dispatched. See `docs/PHASE2F_3_ARTIFACT_HASHES.md`. This section will be patched (not silently rewritten) once real hashes exist. |
